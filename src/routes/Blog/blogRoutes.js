...
router.get("/get", auth, blogController.getBlogs);

// Get everything
router.get("/get/all", auth, blogController.getAllBlogs);

// Get by slug
router.get( "/slug/:slug", auth, blogController.getBlogBySlug);

// Get by ID
router.get( "/get/:id", auth , blogController.getBlogById);
...
// Update reading time
router.post( "/read-time/:id/read-time", auth, blogController.updateReadTime);
